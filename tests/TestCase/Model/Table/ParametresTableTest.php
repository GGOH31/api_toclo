...
class ParametresTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Parametres') ? [] : ['className' => ParametresTable::class];
        $this->Parametres = TableRegistry::getTableLocator()->get('Parametres', $config);
    }
