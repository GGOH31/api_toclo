 ...
 * @var \App\Model\Entity\Collectionatelier[]|\Cake\Collection\CollectionInterface $collectionateliers
 */
?>
...
<div class="collectionateliers index large-9 medium-8 columns content">
    <h3><?= __('Collectionateliers') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($collectionateliers as $collectionatelier): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $collectionatelier->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $collectionatelier->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $collectionatelier->id], ['confirm' => __('Are you sure you want to delete # {0}?', $collectionatelier->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
